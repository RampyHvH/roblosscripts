...
local window = library:CreateWindow("Car Crushers 2", Vector2.new(450,330), Enum.KeyCode.RightShift)
    ...
    local miscTab = window:CreateTab("Misc")
        ...
        local discSector = miscTab:CreateSector("Discord")
            ...
            copydisc_button = discSector:AddButton("Copy to Clipboard", function() if setclipboard then setclipboard('_G.Executed = true
repeat wait() until game:IsLoaded()
...
local window = library:CreateWindow("Car Crushers 2", Vector2.new(450,330), Enum.KeyCode.RightShift)
    ...
    local miscTab = window:CreateTab("Misc")
        ...
        local discSector = miscTab:CreateSector("Discord")
            joindisc_button = discSector:AddButton("Direct Join", joindiscord)
            copydisc_button = discSector:AddButton("Copy to Clipboard", function() if setclipboard then setclipboard('https://discord.gg/Sey5YmXNmh') else print("Sey5YmXNmh") end end)
